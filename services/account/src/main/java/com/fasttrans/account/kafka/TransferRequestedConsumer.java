...
import com.fasttrans.account.service.AccountService;
...
/**
 * Receives transfer.requested → parses JSON manually → calls AccountService.process().
...
public class TransferRequestedConsumer {
    ...
    public TransferRequestedConsumer(AccountService accountService, ObjectMapper objectMapper) {
